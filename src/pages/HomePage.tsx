        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.definitionGrid}>
            ...
            <div className={styles.definitionImage}>
              <img src={`${process.env.PUBLIC_URL}/images/footprint.png`} alt="Визуализация углеродного следа" />
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.sourcesGrid}>
            <div className={styles.sourceItem}>
              ...
              <img src={`${process.env.PUBLIC_URL}/api/placeholder/300/200`} alt="Транспорт как источник CO2" />
            </div>
            <div className={styles.sourceItem}>
              <div className={styles.sourceIcon}>🏭</div>
              <h3>Производство энергии</h3>
              <p>Электростанции, работающие на угле и газе, для производства электричества</p>
              <img src={`${process.env.PUBLIC_URL}/api/placeholder/300/200`} alt="Производство энергии" />
            </div>
            <div className={styles.sourceItem}>
              <div className={styles.sourceIcon}>🏠</div>
              <h3>Домашнее хозяйство</h3>
              <p>Отопление, охлаждение и электричество в наших домах и офисах</p>
              <img src={`${process.env.PUBLIC_URL}/api/placeholder/300/200`} alt="Домашнее хозяйство" />
            </div>
            <div className={styles.sourceItem}>
              <div className={styles.sourceIcon}>🛒</div>
              <h3>Потребление товаров</h3>
              <p>Производство и транспортировка продуктов, одежды и других товаров</p>
              <img src={`${process.env.PUBLIC_URL}/api/placeholder/300/200`} alt="Потребление товаров" />
            </div>
          </div>
        </div>
        <div className={styles.footprint}></div>
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.importanceGrid}>
            <div className={styles.importanceItem}>
              <img src={`${process.env.PUBLIC_URL}/images/i.webp`} alt="Изменение климата" />
              <h3>Изменение климата</h3>
              <p>Повышение температуры приводит к экстремальным погодным условиям</p>
            </div>
            <div className={styles.importanceItem}>
              <img src={`${process.env.PUBLIC_URL}/images/2ca3633e85829de4614a97117a1a1047.jpg`} alt="Таяние ледников" />
              <h3>Таяние ледников</h3>
              <p>Повышение уровня моря угрожает прибрежным регионам</p>
            </div>
            <div className={styles.importanceItem}>
              <img src={`${process.env.PUBLIC_URL}/images/i.jpg`} alt="Потеря биоразнообразия" />
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.solutionsFlex}>
            ...
            <div className={styles.solutionImage}>
              <img src={`${process.env.PUBLIC_URL}/images/ip.webp`} alt="Способы уменьшения углеродного следа" />
            </div>
          </div>
        </div>
        <div className={styles.footprint}></div>
